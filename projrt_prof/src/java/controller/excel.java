...
public class excel extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            Profil p=pr.findById(Integer.parseInt(request.getParameter("excel")));
            String libelle=p.getLibelle();

            
        Document document = new Document();
        // step 2
        PdfWriter.getInstance(document, new FileOutputStream("/Users/macbookpro/Downloads/Employes.xls"));
        document.open();
        ...
        table.getDefaultCell().setHorizontalAlignment(Element.ALIGN_CENTER);
            ...
            em=se.findByProfil(Integer.parseInt(request.getParameter("excel")));
